...
public class LoadMagicFromServerMovieControl : MonoBehaviour
{
    GameObject UpArrow;
    ...
    IEnumerator Move()
    {
        ...
        PackedMagic.GetComponent<RectTransform>().DOLocalMove(new Vector3(0, 0, 0), 0.6f);
        yield return new WaitForSeconds(0.3f);
        ...
        yield return new WaitForSeconds(0.3f);
        UpperBar.GetComponent<RectTransform>().DOScale(new Vector3(0, 1, 0), 0.3f);
        LowerBar.GetComponent<RectTransform>().DOScale(new Vector3(0, 1, 0), 0.3f);
    ...
    void ResetAll()
    {
        ...
        PackedMagic.GetComponent<RectTransform>().localPosition = new Vector3(0, 800, 0);
