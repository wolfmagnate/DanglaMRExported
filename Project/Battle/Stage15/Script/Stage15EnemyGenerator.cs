...
public class Stage15EnemyGenerator : MonoBehaviour
{
    void Start()
    {
    ...
    private IEnumerator GenEnemy()
    {
        ...
        genenemy.GetComponent<EnemyStatusController>().OnDie.AddListener(() => { GameObject.Find("Manager").GetComponent<Stage15SceneControl>().Win(); });
        enemyCash = genenemy;
        yield return null;
    }
