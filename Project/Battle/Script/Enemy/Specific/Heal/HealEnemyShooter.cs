...
public class HealEnemyShooter : EnemyShooter
{
    private HealEnemyAttackShot attackShot;
    ...
    public override void CreateShot(Vector3 position, Quaternion rotation, float Attack, float Speed, float Distance, GameObject Shot)
    {
        ...
        shot.transform.localScale = new Vector3(0.6f, 0.6f, 0.6f);
        attackShot = shot.GetComponent<HealEnemyAttackShot>();
