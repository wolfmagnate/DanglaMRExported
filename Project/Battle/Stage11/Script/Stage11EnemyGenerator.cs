...
public class Stage11EnemyGenerator : MonoBehaviour
{
    ...
    private IEnumerator GenEnemy()
    {
        ...
        var tutorialEnemy3 = CreateEnemy(enemys[2], forwordPosition(8, -30), enemyEffects[2]);
        ...
        var tutorialEnemy4 = CreateEnemy(enemys[3], forwordPosition(8, 0), enemyEffects[3]);
        var tutorialEnemy5 = CreateEnemy(enemys[4], forwordPosition(8, 120), enemyEffects[4]);
        var tutorialEnemy6 = CreateEnemy(enemys[4], forwordPosition(8, 240), enemyEffects[4]);
        ...
        yield return new WaitForSeconds(5);
        battleEnemies.Add(CreateEnemy(enemys[3], forwordPosition(6, 10), enemyEffects[3]).GetComponent<EnemyStatusController>());
        battleEnemies.Add(CreateEnemy(enemys[4], forwordPosition(6, -10), enemyEffects[4]).GetComponent<EnemyStatusController>());
        yield return new WaitForSeconds(5);
        ...
        battleEnemies.Add(CreateEnemy(enemys[2], forwordPosition(6,0), enemyEffects[2]).GetComponent<EnemyStatusController>());
        yield return new WaitForSeconds(4);
        battleEnemies.Add(CreateEnemy(enemys[3], forwordPosition(6,0), enemyEffects[3]).GetComponent<EnemyStatusController>());
        yield return new WaitForSeconds(4);
        battleEnemies.Add(CreateEnemy(enemys[4], forwordPosition(6,0), enemyEffects[4]).GetComponent<EnemyStatusController>());
        yield return new WaitForSeconds(4);
        battleEnemies.Add(CreateEnemy(enemys[0], forwordPosition(6,0), enemyEffects[0]).GetComponent<EnemyStatusController>());
        yield return new WaitForSeconds(4);
        ...
        battleEnemies.Add(CreateEnemy(enemys[3], forwordPosition(6, 0), enemyEffects[3]).GetComponent<EnemyStatusController>());
        yield return WaitDieOf(battleEnemies.ToArray());
        GameObject.Find("Manager").GetComponent<Stage11SceneControl>().HasWin = true;
    }
    ...
    private GameObject CreateEnemy(GameObject enemy, Vector3 position, GameObject effect)
    {
        ...
        generatedEnemy.GetComponent<EnemyStatusController>().OnDie.AddListener(() => GameObject.Find("Manager").GetComponent<Stage11SceneControl>().AddKillCounter());
