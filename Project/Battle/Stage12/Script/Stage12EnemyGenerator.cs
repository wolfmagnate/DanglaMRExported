...
public class Stage12EnemyGenerator : MonoBehaviour
{
    ...
    private IEnumerator GenEnemy()
    {
        ...
        var tutorialEnemy2 = CreateEnemy(enemys[4], new Vector3(-2, 0, -2) + Quaternion.Euler(0, Random.Range(0, 360), 0) * Vector3.forward * 6, effects[4]);
        ...
        yield return WaitDieOf(new EnemyStatusController[] { tutorialEnemy1.GetComponent<EnemyStatusController>() });
        tutorialEnemy2 = CreateEnemy(enemys[3], new Vector3(-2, 0, -2) + Quaternion.Euler(0, Random.Range(0, 360), 0) * Vector3.forward * 6, effects[3]);
        yield return WaitDieOf(new EnemyStatusController[] { tutorialEnemy2.GetComponent<EnemyStatusController>() });
        ...
        yield return WaitDieOf(new EnemyStatusController[] { tutorialEnemy1.GetComponent<EnemyStatusController>() });
        tutorialEnemy2 = CreateEnemy(enemys[4], new Vector3(-2, 0, -2) + Quaternion.Euler(0, Random.Range(0, 360), 0) * Vector3.forward * 6, effects[4]);
        yield return WaitDieOf(new EnemyStatusController[] { tutorialEnemy2.GetComponent<EnemyStatusController>() });
        ...
        enemies.Add(CreateEnemy(enemys[3], new Vector3(-2, 0, -2) + Quaternion.Euler(0, Random.Range(0, 360), 0) * Vector3.forward * 6, effects[3]).GetComponent<EnemyStatusController>());
        yield return new WaitForSeconds(10);
        enemies.Add(CreateEnemy(enemys[4], new Vector3(2, 0, 2) + Quaternion.Euler(0, Random.Range(0, 360), 0) * Vector3.forward * 6, effects[4]).GetComponent<EnemyStatusController>());
        enemies.Add(CreateEnemy(enemys[4], new Vector3(-2, 0, -2) + Quaternion.Euler(0, Random.Range(0, 360), 0) * Vector3.forward * 6, effects[4]).GetComponent<EnemyStatusController>());
        yield return new WaitForSeconds(10);
        ...
        GameObject.Find("Manager").GetComponent<Stage12SceneControl>().HasWin = true;
    ...
    private GameObject CreateEnemy(GameObject enemy, Vector3 position, GameObject effect)
    {
        ...
        generatedEnemy.GetComponent<EnemyStatusController>().OnDie.AddListener(() => GameObject.Find("Manager").GetComponent<Stage12SceneControl>().AddKillCounter());
