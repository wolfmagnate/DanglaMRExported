...
using UnityEngine;
public class Stage10EnemyGenerator : MonoBehaviour
{
    void Start()
    {
    ...
    private IEnumerator GenEnemy()
    {
        ...
        genenemy.GetComponent<EnemyStatusController>().OnDie.AddListener(() => { GameObject.Find("Manager").GetComponent<Stage10SceneControl>().Win(); });
        enemyCash = genenemy;
        yield return null;
    }
