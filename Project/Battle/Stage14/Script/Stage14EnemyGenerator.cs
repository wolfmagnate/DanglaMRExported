...
public class Stage14EnemyGenerator : MonoBehaviour
{
    void Start()
    {
    ...
    private IEnumerator GenEnemy()
    {
        ...
        for (int i = 0; i < 3; i++)
        {
            ...
            yield return WaitDamageOfEnemyHelpPoint(enemyPointStatus, 750 + 3750 * i, 10);
            ...
            yield return WaitDamageOfEnemyHelpPoint(enemyPointStatus, 2250 + 3750 * i, 10);
            ...
            CreateEnemy(enemys[4], HelpPoint.transform.position + Quaternion.Euler(0, Random.Range(0, 360), 0) * Vector3.forward * 6 + Vector3.left, effects[4]);
            ...
            CreateEnemy(enemys[3], HelpPoint.transform.position + Quaternion.Euler(0, Random.Range(0, 360), 0) * Vector3.forward * 6, effects[3]);
            CreateEnemy(enemys[4], HelpPoint.transform.position + Quaternion.Euler(0, Random.Range(0, 360), 0) * Vector3.forward * 7, effects[4]);
            yield return new WaitForSeconds(20);
            ...
            CreateEnemy(enemys[0], HelpPoint.transform.position + Quaternion.Euler(0, Random.Range(0, 360), 0) * Vector3.forward * 6, effects[0]);
            yield return new WaitForSeconds(20);
            CreateEnemy(enemys[1], HelpPoint.transform.position + Quaternion.Euler(0, Random.Range(0, 360), 0) * Vector3.forward * 5, effects[1]);
            CreateEnemy(enemys[2], HelpPoint.transform.position + Quaternion.Euler(0, Random.Range(0, 360), 0) * Vector3.forward * 6, effects[2]);
            CreateEnemy(enemys[3], HelpPoint.transform.position + Quaternion.Euler(0, Random.Range(0, 360), 0) * Vector3.forward * 7, effects[3]);
            yield return new WaitForSeconds(20);
            CreateEnemy(enemys[4], HelpPoint.transform.position + Quaternion.Euler(0, 0, 0) * Vector3.forward * 6 + Vector3.up, effects[4]);
            CreateEnemy(enemys[0], HelpPoint.transform.position + Quaternion.Euler(0, 120, 0) * Vector3.forward * 6 + Vector3.down, effects[0]);
            CreateEnemy(enemys[1], HelpPoint.transform.position + Quaternion.Euler(0, 240, 0) * Vector3.forward * 6, effects[1]);
            yield return new WaitForSeconds(20);

            yield return WaitDamageOfEnemyHelpPoint(enemyPointStatus, 3750 + 3750 * i, 10);
        }
    }
    ...
    private GameObject CreateEnemy(GameObject enemy, Vector3 position, GameObject effect)
    {
        ...
        generatedEnemy.GetComponent<EnemyStatusController>().OnDie.AddListener(() => GameObject.Find("Manager").GetComponent<Stage14SceneControl>().AddKillCounter());
